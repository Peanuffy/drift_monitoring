...
# Загружаем локальную модель PyCaret
model = load_model(LOCAL_MODEL_PATH)

# === Логируем и регистрируем модель в MLflow ===
with mlflow.start_run(run_name="register_drift_model") as run:
...
# === MLflow client для работы с версиями и Stage ===
